...
public interface CustomerDAO {
	...
	int insert(@Bind("c_id") int id, @Bind("c_name") String name, @Bind("c_address") String addr);

	@SqlUpdate("update customer set c_name=:c_name , c_address=:c_address where c_id =:c_id")
	int update(@Bind("c_id") int id, @Bind("c_name") String name, @Bind("c_address") String addr);

	@SqlUpdate("delete from customer where c_id=:c_id")
	int delete(@Bind("c_id") int id);
